...
public class BailsStreamSTAXTest {
    ...
    public void testGetCurrentElement() throws Exception {
        stream.next(); // DOCUMENT_START
        stream.next(); //   <element xmlns:bails='http://www.bails.org/'>
//        assertEquals("element text string is correct.", BailsTestUtil.XML_LINE_ONE, stream.getCharSequence());
    }
    ...
    public void testGetName() throws Exception {
        stream.next(); // DOCUMENT_START
        stream.next(); //   <element xmlns:bails='http://www.bails.org/'>
        assertEquals("element name is correct.", BailsTestUtil.TEST_NAME, stream.getName());
    }
    ...
    public void testGetAttributes() throws Exception {
        ...
        assertNotNull("element attributes contains one.", stream.getAttributes().get(BailsTestUtil.ELEMENT_ATTRIBUTE_ONE));
        assertNotNull("element attributes contains two.", stream.getAttributes().get(BailsTestUtil.ELEMENT_ATTRIBUTE_TWO));
        assertNotNull("element attributes contains three.", stream.getAttributes().get(BailsTestUtil.ELEMENT_ATTRIBUTE_THREE));
    }
    ...
    public void testIntegrationTest() throws Exception {
        ...
        Assert.assertEquals("element children.", BailsTestUtil.CHILD_NUM,
